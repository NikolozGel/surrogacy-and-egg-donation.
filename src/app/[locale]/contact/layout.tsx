// app/[locale]/become-a-surrogate/layout.tsx
...
// ✅ ეს აუცილებლად გჭირდება! ეს არის React კომპონენტი
export default function SurrogateLayout({
  children,
}: {
  children: React.ReactNode;
}) {
  return <>{children}</>; // ან შეგიძლია კონტენტი შემოახვიე <section> ან სხვა სტრუქტურით
}
